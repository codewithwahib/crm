...
<div className="p-4 border-b border-gray-200 flex items-center justify-center">
  ...
  />
        ...
        <nav className="p-4 space-y-1 flex-grow">
          <Link href="/Execution/Dashboard" className={`${navItemClasses('/Execution/Dashboard')} ${dmsans.className}`} onClick={() => setIsOpen(false)}>
            <HomeIcon className="h-5 w-5 mr-3" />
            <span>Dashboard</span>
          </Link>

          <Link href="/Execution/quotation" className={`${navItemClasses('/Execution/quotation')} ${dmsans.className}`} onClick={() => setIsOpen(false)}>
          ...
          <Link
            href="/Execution/Work-Order-Status"
            className={`${navItemClasses('/Execution/Work-Order-Status')} ${dmsans.className}`}
