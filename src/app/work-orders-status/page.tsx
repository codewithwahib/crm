...
export default function WorkOrderDashboard() {
  ...
  // ✅ Status colors for new statuses
      ...
      <main className="max-w-6xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="flex justify-between items-center border-b pb-6">
          ...
          {/* <Link
            ...
            className={`${dmSans.className} tracking-wide px-4 py-2 bg-[#8B5E3C] text-white rounded-md hover:bg-[#6F4A2F] transition-colors`}
          >
            + New Work Order
          </Link> */}
        </div>
        ...
        {filteredWorkOrders.length === 0 && (
          <div className="text-center py-12">
            ...
            {/* <div className="mt-6">
              <Link
                href="/work-orders/create"
                className={`${dmSans.className} tracking-wide inline-flex items-center px-4 py-2 bg-[#8B5E3C] text-white rounded-md hover:bg-[#6F4A2F] transition-colors`}
              >
                + New Work Order
              </Link>
            </div> */}
