    ...
    <ProtectedRoute allowedUser='store'>
      <div className={`min-h-screen bg-white text-gray-800 ${dmSans.variable} font-sans`}>
        ...
        <main className="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          {/* Header Section */}
          <div className="flex justify-between pt-12 items-start pb-4">
            <div className="space-y-1">
              <h1 className={`text-xl md:text-2xl font-bold pt-4 md:pt-12 pl-0 md:pl-4 text-[#8B5E3C] ${dmSans.className}`}>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-6">
            ...
            <div className="md:hidden space-y-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg shadow-sm">
                <h2 className={`text-base font-semibold text-[#8B5E3C] mb-3 pb-2 border-b ${dmSans.className}`}>
                  Basic Information
                </h2>
            ...
            <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Right Column - Inventory Details and Supplier Info */}
